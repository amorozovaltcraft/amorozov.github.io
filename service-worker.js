...
(function (self) {
    ...
    function backgroundMessageHandlerFirebase(payload) {
        (0,_ioc_container__WEBPACK_IMPORTED_MODULE_5__.debug)('push handler firebase');
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            ...
                            return [3 /*break*/, 6];
                        case 6: return [4 /*yield*/, self.registration.showNotification(title_1, {
                                body: body_1,
                                icon: icon_1,
                                tag: tag_1,
                                data: parsedData_1,
    ...
    try {
        ...
        self.addEventListener('install', function (event) {
            /*
                При перезатирании чужого воркера нашим, нам не нужно ждать,
                пока пользователь покинет страницу, поэтому пропускаем этот эпизод
            */
            // @ts-ignore
            self.skipWaiting();
        });
        config.browser = (0,_helper__WEBPACK_IMPORTED_MODULE_4__.getBrowserNameFromURL)(self.location.href);
        if (!config.browser) {
            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_5__.debug)('clickNotificationHandler. Location: ', self.location.href, 'getBrowserNameFromURL:', (0,_helper__WEBPACK_IMPORTED_MODULE_4__.getBrowserNameFromURL)(self.location.href));
        ...
        if ((0,_helper__WEBPACK_IMPORTED_MODULE_4__.shouldUseFirebase)(config)) {
            ...
            var messaging = (0,_firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_2__.getMessaging)();
            // messaging.setBackgroundMessageHandler(backgroundMessageHandlerFirebase);
            (0,_firebase_messaging_sw__WEBPACK_IMPORTED_MODULE_2__.onBackgroundMessage)(messaging, backgroundMessageHandlerFirebase);
            self.addEventListener('notificationclick', clickNotificationHandler);
        }
        else if (config.browser === 'Safari') {
            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_5__.debug)('sw: setup safari ios handlers');
            self.addEventListener('push', safariIOSPushHandler);
            self.addEventListener('notificationclick', IosPWAClickNotificationHandler);
        }
        else {
