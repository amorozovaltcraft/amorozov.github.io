...
/* harmony import */ var _firebase_messaging__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/messaging */ "./node_modules/@firebase/messaging/dist/esm/index.esm2017.js");
...
/* harmony import */ var _ioc_container__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../ioc-container */ "./src/ioc-container.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
(function (windowSelf) {
    var config = deep_clone__WEBPACK_IMPORTED_MODULE_0___default()(_config__WEBPACK_IMPORTED_MODULE_4__.default);
    // Firebase handlers.
    function pushHandlerFirebase(event) {
        ...
        fetch(openLink, {
            ...
            mode: 'no-cors',
            credentials: 'include',
        }).catch(function (e) { return (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)("Can't send open action ", e); });
        fetch(delivLink, {
            method: 'get',
            mode: 'no-cors',
            credentials: 'include',
        }).catch(function (e) { return (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)("Can't send deliv action ", e); });
    }
    function backgroundMessageHandlerFirebase(payload) {
        var _a;
        (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('backgournd push handler firebase.\n', 'SW Received push: ', JSON.stringify(payload, null, 2));
        var title = ((_a = payload.data) === null || _a === void 0 ? void 0 : _a.title) || '';
        var parsedPayload = payload.notification;
        var notificationOptions = {
            body: parsedPayload.body,
    ...
    function safariIOSPushHandler(event) {
        var _this = this;
        var _a;
        (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('push safari ios handler');
        ...
        if (evtData) {
            ...
            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('event data: ', evtData);
            event.waitUntil((function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            e_1 = _a.sent();
                            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)("Can't send deliv action ", e_1);
                            return [3 /*break*/, 3];
                        case 3:
                            _a.trys.push([3, 5, , 6]);
                        ...
                        case 5:
                            e_2 = _a.sent();
                            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)("Can't send deliv action ", e_2);
                            return [3 /*break*/, 6];
    ...
    function IosPWAClickNotificationHandler(event) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('SW Click: ', event);
                event.notification.close();
                event.waitUntil((function () { return __awaiter(_this, void 0, void 0, function () {
                    var url;
                    return __generator(this, function (_a) {
    ...
    function pushHandler(event) {
        (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('push basic handler');
        (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('SW Received push: ');
        (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)(event);
        event.waitUntil(windowSelf.registration.pushManager.getSubscription().then(function (subscription) {
            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('fetch request');
            return fetch(config.serverURL + config.serverPushContentPath, {
                method: 'post',
                credentials: 'include',
                body: JSON.stringify({
                    provider: (0,_helper__WEBPACK_IMPORTED_MODULE_5__.getNormalizedProvider)(config.browser || ''),
                    endpoint: (subscription === null || subscription === void 0 ? void 0 : subscription.endpoint) || '',
                    resource_token: config.resourceToken,
                }),
            }).then(function (response) {
                (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('fetch response: ', response);
                if (response.status !== 200) {
                    throw new Error("Error on getting push content: " + response.status);
                }
                return response.json().then(function (responseData) {
                    (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('fetch parse json: ', responseData);
                    if (responseData.error) {
        ...
        event.waitUntil(windowSelf.clients.matchAll({
            ...
            if (url.indexOf('?provider=') === -1) {
                if ((0,_helper__WEBPACK_IMPORTED_MODULE_5__.shouldUseFirebase)(config)) {
                    url = url + "?provider=" + (0,_helper__WEBPACK_IMPORTED_MODULE_5__.getNormalizedProvider)(config.browser || '') + "Firebase";
                }
                else {
                    url = url + "?provider=" + (0,_helper__WEBPACK_IMPORTED_MODULE_5__.getNormalizedProvider)(config.browser || '');
                }
            }
    ...
    try {
        ...
        if ((0,_helper__WEBPACK_IMPORTED_MODULE_5__.shouldUseFirebase)(config)) {
            ...
            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('sw: setup safari ios handlers');
            ...
            (0,_ioc_container__WEBPACK_IMPORTED_MODULE_6__.debug)('sw: setup default handlers');
